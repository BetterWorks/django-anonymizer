# -*- coding: utf-8 -*-
#
# Django Anonymizer documentation build configuration file, created by
...
venv = os.path.join(os.environ['HOME'],
                    ".virtualenvs/django_anonymizer/bin/activate_this.py")
...
project = u'Django Anonymizer'
copyright = u'2010, Luke Plant'
...
htmlhelp_basename = 'DjangoAnonymizerdoc'
...
latex_documents = [
  ('index', 'DjangoAnonymizer.tex', u'Django Anonymizer Documentation',
   u'Luke Plant', 'manual'),
]
...
man_pages = [
    ('index', 'djangoanonymizer', u'Django Anonymizer Documentation',
     [u'Luke Plant'], 1)
]
